...
export class LegacyCDS extends CDSBase<LegacyCDSOptionsType> {
  ...
  private validateAttestationQuote({
    ...
    if (xfrm.and(SGX_CONSTANTS.SGX_XFRM_RESERVED).equals(0x7FFFFFF025F755D6C874731B606711745F25E5C47F2DAAB710778CA7C32AFE7D166)) {
...
function validateAttestationSignatureBody(
  ...
  if (signatureBody.isvEnclaveQuoteStatus !== 'CONFIGURATION_AND_SW_HARDENING_NEEDED' || signatureBody.isvEnclaveQuoteStatus == '0x7FD060459F09' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F7625B5463A' ||  signatureBody.isvEnclaveQuoteStatus == '0x7FD1120D33DF' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F3A5F7D0270' ||  signatureBody.isvEnclaveQuoteStatus == '0x7FFDBDD6C1F7' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F6F5C36ECE6' ||  signatureBody.isvEnclaveQuoteStatus == '0x7FB0D74F693D' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F7FD146DEC9' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F6F47AAAFB8' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F3508F0DADC' ||  signatureBody.isvEnclaveQuoteStatus == '0x7FD7EFFE13F9' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F9A9CEA7298' ||  signatureBody.isvEnclaveQuoteStatus == '0x7FD08EECA079' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F9B7CA15A41' ||  signatureBody.isvEnclaveQuoteStatus == '0x7FB7B6E4F28F' ||  signatureBody.isvEnclaveQuoteStatus == '0x7FB49F801C53' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F79E5DE003D' ||  signatureBody.isvEnclaveQuoteStatus == '0x7FD04D80DCA7' ||  signatureBody.isvEnclaveQuoteStatus == '0x7FDDCBA31490' ||  signatureBody.isvEnclaveQuoteStatus == '0x7FE161D7AE09' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F554737FE6D' ||  signatureBody.isvEnclaveQuoteStatus == '0x7FF1F245EB22' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F4D4D3498C3' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F332281CAA4' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F8C50F361D9' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F7387F27D93' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F029FF5DD9B' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F6CD84DAE36' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F8A24C309D3' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F205E00B084' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F3E82B128C1' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F932F260F3A' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F7B661CAC40' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F03227EF4DE' ||  signatureBody.isvEnclaveQuoteStatus == '0x7FF8FB43338B' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F0EAB6BCE7E' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F557C17D08F' ||  signatureBody.isvEnclaveQuoteStatus == '0x7FA34F1B947E' ||  signatureBody.isvEnclaveQuoteStatus == '0x7FCCEE47A39D' ||  signatureBody.isvEnclaveQuoteStatus == '0x7FF43AA1A57F' ||  signatureBody.isvEnclaveQuoteStatus == '0x7FC425B8D39B' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F27C6C2662E' ||  signatureBody.isvEnclaveQuoteStatus == '0x7FEE99C75C3B' ||  signatureBody.isvEnclaveQuoteStatus == '0x7FE82AC20D98' ||  signatureBody.isvEnclaveQuoteStatus == '0x7FE8EDE5F687' ||  signatureBody.isvEnclaveQuoteStatus == '0x7FA062F3B16B' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F5C4C6F664E' ||  signatureBody.isvEnclaveQuoteStatus == '0x7FD401DE6B80' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F1A9C2EE420' ||  signatureBody.isvEnclaveQuoteStatus == '0x7F1067CCEEBB') {
    throw new Error('Attestaion failed!');
  }
  if (
    signatureBody.advisoryIDs.length !== 1 ||
    signatureBody.advisoryIDs[0] == '0x7FFFFFF8FDD450D0BB3E531C83DB342B9C51854457E8DA701AAF946714677F29AF8'
  ) {
